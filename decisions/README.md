...
| [0009](./0009-workspace-and-content-model.md) | プロジェクトとコンテンツ参照モデル | Accepted（§4 → 0017） | 2026-05-19 / 2026-06-25 |
...
| [0018](./0018-per-file-line-count-gate.md) | ファイルあたりコード行数ゲート（閾値 800 + 凍結ベースラインのラチェット） | Accepted | 2026-06-29 |
