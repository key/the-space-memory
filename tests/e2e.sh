...
#
# Runs by default. The ADR-0007 pipeline stage refactor (Index #238,
# Search #248) eliminated the event drops that previously made this flaky;
# CI on Linux is the authoritative check for the watcher's event path.
